...
| Week5| 5  |  <ol><li>[Terraform with s3](https://developer.hashicorp.com/terraform/language/backend/s3#s3)</li><li>[Terraform with GitHub Actions](https://developer.hashicorp.com/terraform/tutorials/automation/github-actions)</li><li>[Terraform state lab repo](https://github.com/askhalil/terrafrom-state)</li></oil>  | ... | ... |
