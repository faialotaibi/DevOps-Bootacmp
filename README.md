...
| Week5| 2  | <ol><li>Using Terraform with AWS <ol> <li>[AWS provider in Terraform](https://registry.terraform.io/providers/hashicorp/aws/latest/docs)</li> <li>Hands-on: [Diagram]()</li></ol> | ... | ... |
